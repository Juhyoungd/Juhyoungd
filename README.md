...
정보처리기사 / 산업기능요원 보충역 / Next.js·TypeScript 기반 웹 개발
...
## 🙋 About Me
- 사용자 인터랙션과 데이터 흐름을 함께 고려하는 프론트엔드 개발자입니다.
- 팀 프로젝트 **NEXTSTEP**에서 커뮤니티(게시글/댓글 CRUD), 회원(프로필/포인트/퀘스트/상점), 관리자 API를 담당했습니다.
- React Query 기반 데이터 패칭, FSD(Feature-Sliced Design) 아키텍처 설계 경험이 있습니다.
...
- **기술 스택**: Next.js, TypeScript, React Query, Supabase, FSD 아키텍처
- **담당 영역**
  - 커뮤니티 페이지: 게시글/댓글 CRUD 기능 구현
